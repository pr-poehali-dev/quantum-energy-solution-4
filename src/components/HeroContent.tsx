...
export default function HeroContent() {
  ...
  return (
    <>
      <main className="absolute bottom-16 left-4 right-4 sm:bottom-8 sm:left-8 sm:right-auto z-20 max-w-sm sm:max-w-lg max-h-[80vh] sm:max-h-none overflow-y-auto">
