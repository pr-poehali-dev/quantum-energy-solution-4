...
export default function HeroContent() {
  ...
  return (
    <>
      <main className="absolute bottom-32 left-4 right-4 sm:bottom-8 sm:left-8 sm:right-auto z-20 max-w-sm sm:max-w-lg max-h-[75vh] sm:max-h-none overflow-y-auto">
        <div className="text-left">
          <p className="text-xs sm:text-sm font-light text-white/70 mb-4 leading-relaxed">
