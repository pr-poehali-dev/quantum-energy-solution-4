...
export default function HeroContent() {
  ...
  return (
    <>
      <main className="absolute bottom-64 left-4 right-4 sm:bottom-8 sm:left-8 sm:right-auto z-20 max-w-sm sm:max-w-lg max-h-[65vh] sm:max-h-none overflow-y-auto">
        <div className="text-left">
          <p className="text-xs sm:text-sm font-light text-white mb-4 leading-relaxed [text-shadow:0_1px_12px_rgba(0,0,0,1),0_0_20px_rgba(0,0,0,0.9)]">
